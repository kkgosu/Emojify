object Libs {
    ...
    const val ROOM_KTX = "androidx.room:room-ktx:2.5.0-alpha02"
    const val ROOM_RUNTIME = "androidx.room:room-runtime:2.5.0-alpha02"
    ...
    object Compose {
        ...
        private const val appcompanist_version = "0.28.0"
